...
class PwdHashGenerator (object):
    ...
    """
    def _apply_constraints(self, phash, size, nonalphanumeric):
        """
    ...
    def _b64_hmac_md5 (self, key, data):
        """
...
if __name__ == '__main__':
    ...
    #
    # ask the user's master password and create a generator
    #
